...
Below is a quick introduction to WfBase package.  If you need more information about WfBase, take a look at the :ref:`additional examples <examples>` of using WfBase.  See also :ref:`detailed technical description <usage>` of all WfBase functionalities.
